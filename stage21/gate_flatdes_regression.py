...
DISABLED (desorption_flat=False), the model must be bit-identical to the
...
print(f'GATE PASS: desorption_flat=False bit-identical to stage-3.0 build over {N} steps')

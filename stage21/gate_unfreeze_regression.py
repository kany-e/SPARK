...
DISABLED (flip_unfreeze=False), the model must be bit-identical to the
...
print(f'GATE PASS: flip_unfreeze=False bit-identical to stage-3.0 build over {N} steps')
